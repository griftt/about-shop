...
<div class="topMenu">
  <div class="pW">
    ...
    <ul class="fr topTh">
      ...
      <li class="d3 tShow"><a name="sfbest_hp_hp_head_weibo" class="trackref" title="关注SHOP商城微博" href="http://weibo.com/sfbest" rel="nofollow" target="_blank"><q></q></a></li>
      <li class="d4 tShow"><q></q><!--微信-->
         <div class="dd">
         <div class="sf_wx_t">关注SHOP商城微信</div>
         <div class="sf_wx"></div>
        </div>
        <div class="corner">
          <div class="aBg"></div>
