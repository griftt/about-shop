    ...
    <ul class="individualUserBg">
        <form id="regForm_mod" name="regForm_mod" method="post"  >
			...
			<span  class="regM" style="margin-left:29px">
				...
				<a href="https://passport.e3mall.cn/xy.html" target="_blank"  class="checkTitle">我已阅读并同意<font style="font-size:12px;">《SHOP商城用户注册协议》</font></a>
			</span>
...
<!--mainOver-->
		...
		<div class="footer">
			...
			<p> 
				...
				Copyright© SHOP商城 e3mall.cn 版权所有<br /> 
			</p>
		</div>
		<!-- /footer -->
